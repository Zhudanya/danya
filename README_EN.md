...
- **Tool System** — Extensible architecture (22 general + 13 game-specific = 35 tools)

### Game Development
- **Engine Awareness** — Auto-detect Unity / UE / Godot / Go server, inject engine domain knowledge
...
4 engine templates built-in (Unity, Go Server, Unreal, Godot). Users can freely customize — Danya never overwrites your changes.
...
| **AssetCheck** | Asset reference integrity | Unity, Godot |
