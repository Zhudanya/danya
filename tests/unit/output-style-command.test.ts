...
describe('/output-style (menu + direct set + help)', () => {
  ...
  const originalConfigDir = process.env.DANYA_CONFIG_DIR
  ...
  beforeEach(async () => {
    ...
    process.env.DANYA_CONFIG_DIR = join(homeDir, '.danya')
  ...
  afterEach(async () => {
    ...
    if (originalConfigDir === undefined) delete process.env.DANYA_CONFIG_DIR
    else process.env.DANYA_CONFIG_DIR = originalConfigDir
    rmSync(projectDir, { recursive: true, force: true })
    rmSync(homeDir, { recursive: true, force: true })
  })

  test('direct set persists outputStyle to .danya/settings.local.json', async () => {
