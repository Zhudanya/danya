...
var VALID_SCOPES, EXTERNAL_SCOPES;
var init_discovery = __esm({
  "src/services/mcp/discovery.ts"() {
    ...
    init_sessionPlugins();
    init_jsonc();
    VALID_SCOPES = ["project", "global", "mcprc", "mcpjson"];
    EXTERNAL_SCOPES = [
      "project",
      "global",
      "mcprc",
...
var DEFAULT_TIMEOUT_MS, MAX_TIMEOUT_MS, MAX_OUTPUT_LENGTH, MAX_RENDERED_LINES, PROJECT_URL, DEFAULT_CO_AUTHOR, TOOL_NAME_BASH, TOOL_NAME_GLOB, TOOL_NAME_GREP, TOOL_NAME_READ, TOOL_NAME_EDIT, TOOL_NAME_WRITE, TOOL_NAME_TASK;
var init_prompt2 = __esm({
  "src/tools/system/BashTool/prompt.ts"() {
    init_sandboxConfig();
    DEFAULT_TIMEOUT_MS = 12e4;
    MAX_TIMEOUT_MS = 6e5;
    MAX_OUTPUT_LENGTH = 3e4;
    MAX_RENDERED_LINES = 5;
    PROJECT_URL = "https://github.com/shareAI-lab/kode";
    DEFAULT_CO_AUTHOR = "ShareAI Lab";
    TOOL_NAME_BASH = "Bash";
    TOOL_NAME_GLOB = "Glob";
    TOOL_NAME_GREP = "Grep";
    TOOL_NAME_READ = "Read";
    TOOL_NAME_EDIT = "Edit";
    TOOL_NAME_WRITE = "Write";
    TOOL_NAME_TASK = "Task";
  }
});
...
var IDE_MCP_TOOL_ALLOWLIST, getMCPTools, getMCPCommands;
var init_tools_integration = __esm({
  "src/services/mcp/tools-integration.ts"() {
    init_MCPTool();
    init_log();
    init_client();
    IDE_MCP_TOOL_ALLOWLIST = /* @__PURE__ */ new Set([
      "mcp__ide__executeCode",
      "mcp__ide__getDiagnostics"
    ]);
    getMCPTools = memoize2(async () => {
