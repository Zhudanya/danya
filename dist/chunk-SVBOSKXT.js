...
var API_ERROR_MESSAGE_PREFIX, PROMPT_TOO_LONG_ERROR_MESSAGE, CREDIT_BALANCE_TOO_LOW_ERROR_MESSAGE, INVALID_API_KEY_ERROR_MESSAGE, NO_CONTENT_MESSAGE, MAIN_QUERY_TEMPERATURE;
var init_llmConstants = __esm({
  "src/services/ai/llmConstants.ts"() {
    ...
    INVALID_API_KEY_ERROR_MESSAGE = "Invalid API key \xB7 Please run /login";
...
var INTERRUPT_MESSAGE, INTERRUPT_MESSAGE_FOR_TOOL_USE, CANCEL_MESSAGE, REJECT_MESSAGE, REJECT_MESSAGE_WITH_FEEDBACK_PREFIX, REJECTED_PLAN_PREFIX, NO_RESPONSE_REQUESTED, SYNTHETIC_ASSISTANT_MESSAGES, getToolResultIDs, STRIPPED_TAGS;
var init_core = __esm({
  "src/utils/messages/core.ts"() {
    init_llmConstants();
    ...
    REJECT_MESSAGE_WITH_FEEDBACK_PREFIX = `The user doesn't want to proceed with this tool use. The tool use was rejected (eg. if it was a file edit, the new_string was NOT written to the file). To tell you how to proceed, the user said:
`;
    REJECTED_PLAN_PREFIX = `The agent proposed a plan that was rejected by the user. The user chose to stay in plan mode rather than proceed with implementation.

Rejected plan:
`;
    NO_RESPONSE_REQUESTED = "No response requested.";
    SYNTHETIC_ASSISTANT_MESSAGES = /* @__PURE__ */ new Set([
      INTERRUPT_MESSAGE,
...
__export(messages_exports, {
  ...
  REJECTED_PLAN_PREFIX: () => REJECTED_PLAN_PREFIX,
  REJECT_MESSAGE: () => REJECT_MESSAGE,
  REJECT_MESSAGE_WITH_FEEDBACK_PREFIX: () => REJECT_MESSAGE_WITH_FEEDBACK_PREFIX,
  SYNTHETIC_ASSISTANT_MESSAGES: () => SYNTHETIC_ASSISTANT_MESSAGES,
  ...
  extractTagFromMessage: () => extractTagFromMessage,
  filterUserTextMessagesForUndo: () => filterUserTextMessagesForUndo,
  getErroredToolUseMessages: () => getErroredToolUseMessages,
  getInProgressToolUseIDs: () => getInProgressToolUseIDs,
  getLastAssistantMessageId: () => getLastAssistantMessageId,
  getToolUseID: () => getToolUseID,
  getUnresolvedToolUseIDs: () => getUnresolvedToolUseIDs,
  isEmptyMessageText: () => isEmptyMessageText,
  isNotEmptyMessage: () => isNotEmptyMessage,
...
async function processUserInput(input, mode, setToolJSX, context, pastedImages) {
  const impl = await import("./userInput-ANC2VDF3.js");
