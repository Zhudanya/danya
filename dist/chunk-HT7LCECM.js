...
var init_model = __esm({
  "src/utils/model/index.ts"() {
    ...
    init_debugLogger();
    init_config();
    USE_BEDROCK = !!(process.env.DANYA_USE_BEDROCK ?? process.env.KODE_USE_BEDROCK ?? process.env.CLAUDE_CODE_USE_BEDROCK);
    USE_VERTEX = !!(process.env.DANYA_USE_VERTEX ?? process.env.KODE_USE_VERTEX ?? process.env.CLAUDE_CODE_USE_VERTEX);
