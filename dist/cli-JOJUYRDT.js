...
import {
  getAllTools
} from "./chunk-H7IYVCDH.js";
import {
  DanyaAgentStructuredStdio
} from "./chunk-ENVQDI7A.js";
import {
  assertMinVersion
} from "./chunk-EIRUZERY.js";
import {
  getToolDescription,
  init_tool
} from "./chunk-ORETXRSM.js";
import {
  init_generators,
  lastX
} from "./chunk-S3ERYO5R.js";
import {
  Doctor,
  Onboarding,
  ResumeConversation,
...
import "./chunk-JYSGT3XH.js";
import "./chunk-X5J77R43.js";
import {
  clearOutputStyleCache,
  init_outputStyles
} from "./chunk-FDPYNXS5.js";
import "./chunk-3Q6FP5OW.js";
import "./chunk-KWYKOM5M.js";
...
} from "./chunk-HBGDGK5Y.js";
import {
  ConfigParseError,
  init_errors
} from "./chunk-2KMDVUZ2.js";
import {
  debug,
  initDebugLogger,
  init_debugLogger
} from "./chunk-KNCVPLW3.js";
import {
  BunShell,
  CACHE_PATHS,
  PRODUCT_COMMAND,
...
async function runPrintModeStreamJsonSession(args) {
  const { runDanyaAgentStreamJsonSession } = await import("./kodeAgentStreamJsonSession-BXDYINLI.js");
...
`);
  ...
  const { createUserMessage } = await import("./messages-D4UYQ4HZ.js");
  const { getSystemPrompt } = await import("./prompts-SQJOFQSI.js");
  const { getContext: getContext2 } = await import("./context-C6BK2IFV.js");
  const { getTotalCost } = await import("./costTracker-66WURBTU.js");
  const { query } = await import("./query-XT5AXYRV.js");
  ...
  } = await import("./toolPermissionSettings-UHW2MOJQ.js");
  const { applyToolPermissionContextUpdates } = await import("./toolPermissionContext-A7QBIBG7.js");
...
async function setup(cwd2, safeMode) {
  ...
  let agentLoader;
  try {
    agentLoader = await import("./loader-SUPIMU7Y.js");
  } catch {
    agentLoader = await import("./loader-SUPIMU7Y.js");
  }
...
`
      ...
      assertMinVersion();
      {
        ...
        const { listEnabledInstalledPluginPackRoots } = await import("./skillMarketplace-NUR2YQCG.js");
        ...
        if (deduped.length > 0) {
          const { configureSessionPlugins } = await import("./pluginRuntime-2RZPKXP6.js");
      ...
      const [{ ask }, { getTools }, { getCommands }] = await Promise.all([
        import("./ask-DNV7OPNB.js"),
        import("./tools-GEOONXJX.js"),
        import("./commands-JWNWGFQZ.js")
      ]);
      ...
      } = await import("./kodeAgentSessionLoad-ZQGBQB35.js");
      const { listDanyaAgentSessions, resolveResumeSessionIdentifier } = await import("./kodeAgentSessionResume-QCSXGWKU.js");
      const { isUuid } = await import("./uuid-XCBIOUKJ.js");
      const { setDanyaAgentSessionId, getDanyaAgentSessionId } = await import("./kodeAgentSessionId-BPMFFX36.js");
      ...
      if (print) {
        ...
        const updateInfo = await (async () => {
          try {
            const [
              ...
              import("./autoUpdater-6RQ36MRV.js"),
              import("semver")
            ]);
        ...
        {
          const { render: render3 } = await import("ink");
          const { REPL } = await import("./REPL-BXUCS5TH.js");
          render3(
            /* @__PURE__ */ React10.createElement(
              REPL,
              {
  ...
  modelsCmd.command("import <file>").description("Import model config YAML (merges by default)").option("--cwd <cwd>", "The current working directory", String, cwd()).option("--replace", "Replace existing model profiles instead of merging").action(async (file, { cwd: cwd2, replace }) => {
    try {
      ...
      await import("./model-E77B7QKO.js").then(({ reloadModelManager }) => {
        reloadModelManager();
      });
  ...
  modelsCmd.command("list").description("List configured model profiles and pointers").option("--cwd <cwd>", "The current working directory", String, cwd()).option("--json", "Output as JSON").action(async (options) => {
    try {
      ...
      const { reloadModelManager, getModelManager: getModelManager2 } = await import("./model-E77B7QKO.js");
      reloadModelManager();
  ...
  agentsCmd.command("validate [paths...]").description("Validate agent markdown files (defaults to user+project agent dirs)").option("--cwd <cwd>", "The current working directory", String, cwd()).option("--json", "Output as JSON").option("--no-tools-check", "Skip validating tool names against the tool registry").action(
    async (paths, options) => {
      try {
        const workingDir = typeof options?.cwd === "string" ? options.cwd : cwd();
        await setup(workingDir, false);
        const { validateAgentTemplates } = await import("./agentsValidate-U3JEDWCC.js");
...
`
  ...
  const registerMarketplaceCommands = (marketplaceCmd2) => {
    marketplaceCmd2.command("add <source>").description("Add a marketplace from a URL, path, or GitHub repo").action(async (source) => {
      try {
        const { addMarketplace } = await import("./skillMarketplace-NUR2YQCG.js");
    ...
    marketplaceCmd2.command("list").description("List all configured marketplaces").option("--json", "Output as JSON").action(async (options) => {
      try {
        const { listMarketplaces } = await import("./skillMarketplace-NUR2YQCG.js");
    ...
    marketplaceCmd2.command("remove <name>").alias("rm").description("Remove a configured marketplace").action(async (name) => {
      try {
        const { removeMarketplace } = await import("./skillMarketplace-NUR2YQCG.js");
    ...
    marketplaceCmd2.command("update [name]").description(
      ...
      try {
        ...
        } = await import("./skillMarketplace-NUR2YQCG.js");
  ...
  pluginCmd.command("install <plugin>").alias("i").description(
    ...
    try {
      ...
      const { setCwd: setCwd2 } = await import("./state-SRMKZFNP.js");
      await setCwd2(options.cwd ?? cwd());
      const { installSkillPlugin } = await import("./skillMarketplace-NUR2YQCG.js");
...
${skillList}`);
  ...
  pluginCmd.command("uninstall <plugin>").alias("remove").alias("rm").description("Uninstall an installed plugin").option("--cwd <cwd>", "The current working directory", String, cwd()).option(
    ...
    try {
      ...
      const { setCwd: setCwd2 } = await import("./state-SRMKZFNP.js");
      await setCwd2(options.cwd ?? cwd());
      const { uninstallSkillPlugin } = await import("./skillMarketplace-NUR2YQCG.js");
...
${skillList}`);
  ...
  pluginCmd.command("list").description("List installed plugins").option("--cwd <cwd>", "The current working directory", String, cwd()).option(
    ...
    try {
      ...
      const { setCwd: setCwd2, getCwd: getCwd2 } = await import("./state-SRMKZFNP.js");
      await setCwd2(options.cwd ?? cwd());
      const { listInstalledSkillPlugins } = await import("./skillMarketplace-NUR2YQCG.js");
...
`);
  ...
  pluginCmd.command("enable <plugin>").description("Enable a disabled plugin").option("--cwd <cwd>", "The current working directory", String, cwd()).option(
    ...
    try {
      ...
      const { setCwd: setCwd2 } = await import("./state-SRMKZFNP.js");
      await setCwd2(options.cwd ?? cwd());
      const { enableSkillPlugin } = await import("./skillMarketplace-NUR2YQCG.js");
  ...
  pluginCmd.command("disable <plugin>").description("Disable an enabled plugin").option("--cwd <cwd>", "The current working directory", String, cwd()).option(
    ...
    try {
      ...
      const { setCwd: setCwd2 } = await import("./state-SRMKZFNP.js");
      await setCwd2(options.cwd ?? cwd());
      const { disableSkillPlugin } = await import("./skillMarketplace-NUR2YQCG.js");
  ...
  pluginCmd.command("validate <path>").description("Validate a plugin or marketplace manifest").option("--cwd <cwd>", "The current working directory", String, cwd()).action(async (path, options) => {
    try {
      const { setCwd: setCwd2 } = await import("./state-SRMKZFNP.js");
      await setCwd2(options.cwd ?? cwd());
      const { formatValidationResult, validatePluginOrMarketplacePath } = await import("./pluginValidation-SV64W2MC.js");
...
${skillList}`);
  ...
  mcp.command("add-from-claude-desktop").description(
    ...
    try {
      ...
      const utilsTheme = await import("./theme-XEQETCF4.js");
  ...
  program.command("update").description("Show manual upgrade commands (no auto-install)").action(async () => {
    ...
    const { getLatestVersion, getUpdateCommandSuggestions } = await import("./autoUpdater-6RQ36MRV.js");
  ...
  program.command("resume").description(
    ...
    async (identifier, { cwd: cwd2, enableArchitect, safe, verbose, disableSlashCommands }) => {
      ...
      if (identifier !== void 0) {
        const { loadDanyaAgentSessionMessages } = await import("./kodeAgentSessionLoad-ZQGBQB35.js");
        const { resolveResumeSessionIdentifier } = await import("./kodeAgentSessionResume-QCSXGWKU.js");
        const { setDanyaAgentSessionId } = await import("./kodeAgentSessionId-BPMFFX36.js");
        ...
        const { listDanyaAgentSessions } = await import("./kodeAgentSessionResume-QCSXGWKU.js");
        const sessions = listDanyaAgentSessions({ cwd: cwd2 });
        if (sessions.length === 0) {
          console.error("No conversation found to resume");
          process.exit(1);
...
async function gracefulExit(code = 0) {
  ...
  try {
    const { runSessionEndHooks } = await import("./kodeHooks-JTJ4TK3L.js");
    const { getDanyaAgentSessionId } = await import("./kodeAgentSessionId-BPMFFX36.js");
