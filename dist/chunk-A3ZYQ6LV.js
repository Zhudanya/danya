...
var lastUuidByFile, snapshotWrittenByFile, slugBySessionId, currentSessionCustomTitle, currentSessionTag, gitBranchCache;
var init_kodeAgentSessionLog = __esm({
  "src/utils/protocol/kodeAgentSessionLog.ts"() {
    init_macros();
    init_state();
    init_kodeAgentSessionId();
    init_env();
    init_planSlugWords();
    lastUuidByFile = /* @__PURE__ */ new Map();
    snapshotWrittenByFile = /* @__PURE__ */ new Set();
    slugBySessionId = /* @__PURE__ */ new Map();
