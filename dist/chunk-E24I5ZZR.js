...
async function runPromptHook(args) {
  ...
  try {
    const { queryQuick } = await import("./llmLazy-5OUEKADX.js");
    const systemPrompt = [
...
var cache, pluginHooksCache, sessionStartCache, HOOK_RUNTIME_STATE_KEY;
var init_kodeHooks = __esm({
  "src/utils/session/kodeHooks.ts"() {
    init_log();
    init_state();
    init_kodeAgentSessionId();
    ...
    pluginHooksCache = /* @__PURE__ */ new Map();
    sessionStartCache = /* @__PURE__ */ new Map();
    HOOK_RUNTIME_STATE_KEY = "__danyaHookRuntimeState";
  }
});
