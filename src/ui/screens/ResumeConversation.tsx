...
import type { DanyaAgentSessionListItem } from '@utils/protocol/kodeAgentSessionResume'
import { logError } from '@utils/log'
import type { Tool } from '@tool'
import { Command } from '@commands'
import { isDefaultSlowAndCapableModel } from '@utils/model'
import type { WrappedClient } from '@services/mcpClient'
import { loadDanyaAgentSessionMessages } from '@utils/protocol/kodeAgentSessionLoad'
import { setDanyaAgentSessionId } from '@utils/protocol/kodeAgentSessionId'
...
type Props = {
  ...
  sessions: DanyaAgentSessionListItem[]
  tools: Tool[]
...
export function ResumeConversation({
  ...
  async function onSelect(index: number) {
    try {
      ...
      const messages = loadDanyaAgentSessionMessages({
        cwd,
