...
function getUserDanyaBaseDir(): string {
...
export function getCustomCommandDirectories(): {
  ...
  userDanyaCommands: string
  projectDanyaCommands: string
  userDanyaSkills: string
  projectDanyaSkills: string
} {
  const userDanyaBaseDir = getUserDanyaBaseDir()
  return {
...
export function hasCustomCommands(): boolean {
  ...
  return (
    ...
    existsSync(dirs.userDanyaCommands) ||
    existsSync(dirs.projectDanyaCommands) ||
    existsSync(dirs.userDanyaSkills) ||
    existsSync(dirs.projectDanyaSkills)
  )
}
