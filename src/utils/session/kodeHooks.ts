...
const HOOK_RUNTIME_STATE_KEY = '__danyaHookRuntimeState'
...
export function __resetDanyaHooksCacheForTests(): void {
  cache.clear()
  pluginHooksCache.clear()
  sessionStartCache.clear()
}

export { __resetDanyaHooksCacheForTests as __resetKodeHooksCacheForTests }
