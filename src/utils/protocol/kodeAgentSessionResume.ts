...
export type DanyaAgentSessionListItem = {
  sessionId: string
  slug: string | null
...
function readSessionListItemBestEffort(args: {
  filePath: string
  sessionId: string
}): Omit<DanyaAgentSessionListItem, 'sessionId'> {
...
export function listDanyaAgentSessions(args: {
  cwd: string
}): DanyaAgentSessionListItem[] {
  const { cwd } = args
...
/** @deprecated Use listDanyaAgentSessions */
export const listKodeAgentSessions = listDanyaAgentSessions
/** @deprecated Use DanyaAgentSessionListItem */
export type KodeAgentSessionListItem = DanyaAgentSessionListItem
